...
public class HistoryController : Controller
{
    ...
    public IActionResult Index()
    {
        ...
        viewModel.Summaries.Add(new ModeSummaryViewModel
        {
            ...
            AverageTimePerHand = defenceSessions.Any() ? defenceSessions.Average(s => s.AverageTimePerHand) : 0,
            AverageAccuracy = defenceSessions.Any() ? defenceSessions.Average(s => s.NumberOfHands > 0 ? (double)s.CorrectAnswersCount * 100 / s.NumberOfHands : 0) : 0
        });
        ...
        viewModel.Summaries.Add(new ModeSummaryViewModel
        {
            ...
            AverageTimePerHand = handSessions.Any() ? handSessions.Average(s => s.AverageTimePerHand) : 0,
            AverageAccuracy = handSessions.Any() ? handSessions.Average(s => s.NumberOfHands > 0 ? (double)s.CorrectAnswersCount * 100 / s.NumberOfHands : 0) : 0
        });
        ...
        viewModel.Summaries.Add(new ModeSummaryViewModel
        {
            ...
            AverageTimePerHand = distSessions.Any() ? distSessions.Average(s => s.AverageTimePerHand) : 0,
            AverageAccuracy = distSessions.Any() ? distSessions.Average(s => s.NumberOfHands > 0 ? (double)s.CorrectAnswersCount * 100 / s.NumberOfHands : 0) : 0
        });
